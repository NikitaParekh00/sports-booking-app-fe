                ...
                {tournaments.length === 0 ? (
                    ...
                    <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-3">
                        {tournaments.map((tournament) => (
                            <div key={tournament.id} className="rounded-lg p-4 hover:shadow-md transition-shadow border border-gray-200 bg-white">
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            const tournamentData = {
                ...
                number_of_courts: clampCourtCountCreate(formData.number_of_courts),
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                        ...
                        <div>
                            ...
                            <input
                                ...
                                onChange={(e) => {
                                    ...
                                    setFormData({ ...formData, number_of_courts: Number.isFinite(v) ? v : 3 });
                                }}
                                className="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 bg-white text-gray-900 text-sm md:text-base"
                            />
                            <p className="text-xs text-gray-600 mt-1">Parallel courts for team schedule (default 3).</p>
                        </div>
                        <div>
                            <label className="block text-sm font-medium text-gray-700 mb-2">
                                Prize Pool (₹)
                        ...
                        <div className="space-y-4">
                            ...
                            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                                <div>
                                    ...
                                    {isPickleball && (
                                        <p className="text-xs text-gray-600 mt-1">Pickleball matches are typically best of 3 games</p>
                                    )}
                                    {isBadminton && (
                                        <p className="text-xs text-gray-600 mt-1">Badminton matches are typically best of 3 games (first to 2)</p>
                                    )}
                                </div>
                                ...
                                <div>
                                    ...
                                    {isPickleball && (
                                        <p className="text-xs text-gray-600 mt-1">Standard pickleball games are played to 11 points (win by 2)</p>
                                    )}
                                    {isBadminton && (
                                        <p className="text-xs text-gray-600 mt-1">Standard badminton games are played to 21 points (win by 2, cap at 30)</p>
                                    )}
                                </div>
                            </div>
                    ...
                    <div className="border-t border-gray-200 pt-6 mt-6">
                        ...
                        <div className="bg-gray-50 border border-gray-200 rounded-lg p-4 mb-4 space-y-3">
                            <h3 className="text-sm font-medium text-gray-900">Upload from sheet (CSV)</h3>
